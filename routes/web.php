...
Route::middleware(['auth'])->group(function () {
    ...
    Route::group(['prefix' => '/siswa', 'middleware' => ['can:isSiswa']], function () {
    ...
    Route::group(['prefix' => '/kesiswaan', 'middleware' => ['can:isKesiswaan']], function () {
        Route::get('/', [App\Http\Controllers\KesiswaanController::class, 'index'])->name('kesiswaan.index');
    ...
    Route::group(['prefix' => '/wali-kelas', 'middleware' => ['can:isWaliKelas']], function () {
        Route::get('/', [App\Http\Controllers\WaliController::class, 'index'])->name('wali-kelas.index');
    ...
    Route::group(['prefix' => '/wali-siswa', 'middleware' => ['can:isWaliSiswa']], function () {
        Route::get('/', [App\Http\Controllers\WaliSiswaController::class, 'index'])->name('wali-siswa.index');
