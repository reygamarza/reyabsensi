                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="au-card p-4 shadow-sm">
                            <form action="{{ route('kesiswaan.editprofile') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="row form-group mb-3">
                                <div class="col-lg-12">
                                    ...
                                    <input type="text" id="nama" name="nama" placeholder="Masukan Nama Lengkap" class="form-control" value="{{ $kesiswaan->nama }}" required>
                                </div>
                            </div>
                            <div class="row form-group mb-3">
                                <div class="col-lg-12">
                                    <label for="email" class="form-control-label"><b>Email</b></label>
                                    <input type="email" id="email" name="email" placeholder="Masukan Email" class="form-control" value="{{ $kesiswaan->email }}" required>
                                </div>
                            </div>
                            <div class="row form-group mb-3">
                                <div class="col-lg-12">
